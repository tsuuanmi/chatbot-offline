...
log "Checking liveness and readiness"
...
log "Checking authenticated chat"
...
with urllib.request.urlopen(
    ...
    if not isinstance(
        ...
        raise RuntimeError(
            "chat response is invalid"
        )

print(
    "OFFLINE AUTHENTICATED CHAT PASS"
)
PY
